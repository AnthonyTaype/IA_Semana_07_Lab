...
public class Jabon extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		else if(cant>=12 && cant<18){impD=impC*0.10;}
		else if(cant>=6 && cant<12){impD=impC*0.75;}
		else{impD=impC*0;}
		
		impP = impC-impD;
		
		if(cant>=12){ lapizero = 2;}
		else if(cant>=12 && cant<24){ lapizero = 4;}
		else if(cant>=24 && cant<36){ lapizero = 1*cant;}
		else { lapizero= 2*cant; }
		
		txtS.setText("PAQUETE DE JABONES \n\n");
